"""
    ...
    Hosts the server to receive a .bmp file from the client, and reconstructs received.bmp file for every the packets it receives
    Utilizes the same UDP sockets as phase 1a
...
## Construct image while server is running (check if file already exists)
