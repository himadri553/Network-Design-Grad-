...
class RECEIVER_2:
    def __init__(self):
        ...
        self.rx_socket.bind(('localhost', main1b_helper.receiver_port))
    ...
    def reconstruct_image(self, pic_data):
        ...
        with open (main1b_helper.output_pic_path, "wb") as f:
            f.write(full_data)
    ...
    def rx_receive(self):
        ...
        try:
            rx_data, self.sender_address = self.rx_socket.recvfrom(main1b_helper.buffer_size)
