...
class SENDER_2:
    ...
    def log_print(self, message):
        ...
        with open(main1b_helper.log_path, 'a') as log_file:
    ...
    def pic_to_chunks(self):
        ...
        if not self.all_chunks:
            with open(main1b_helper.pic_path, "rb") as f:
                data = f.read()
            
            total_bytes = len(data)
            num_packets = (total_bytes + main1b_helper.packet_size - 1) // main1b_helper.packet_size

            for i in range(num_packets):
                chunk = data[i * main1b_helper.packet_size : (i + 1) * main1b_helper.packet_size]
    ...
    def tx_send(self, data):
        ...
        self.sender_socket.sendto(data, (main1b_helper.receiver_name, main1b_helper.receiver_port))
        time.sleep(0.001)
    ...
    def tx_receive(self):
        ...
        try:
            data, rx_address = self.sender_socket.recvfrom(main1b_helper.buffer_size)
            return data
        except:
